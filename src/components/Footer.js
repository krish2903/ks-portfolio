  ...
  return (
    <div  id='footer'>
      <div className="w-full flex justify-center bg-white">
        <div onClick={handleScrollToTop} className="flex flex-col pt-[calc(3rem-30px)] items-center absolute translate-y-[-3rem] h-[6rem] w-[7rem] rounded-[50%] bg-white cursor-pointer hover:scale-110 duration-500">
